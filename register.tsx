    ...
    <PageTransition>
      ...
      >
        ...
        <div className="flex-1 flex items-start justify-center pt-12 p-4">
          ...
          >
            <h1
              className={`text-[32px] font-bold text-center mb-8 transition-colors duration-500 ${
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mb-6">
              <div className="flex flex-col items-center">
                ...
                />
                {errors.firstName && (
                  <span className="text-red-500 text-xs mt-1 self-start max-w-xs animate-pulse">
                    {errors.firstName}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                />
                {errors.lastName && (
                  <span className="text-red-500 text-xs mt-1 self-start max-w-xs animate-pulse">{errors.lastName}</span>
                )}
              </div>
